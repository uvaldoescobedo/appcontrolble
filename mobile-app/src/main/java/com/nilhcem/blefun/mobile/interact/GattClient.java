...
import static com.nilhcem.blefun.common.AwesomenessProfile.SERVICE_UUID_FIRST;
...
public class GattClient {
    ...
    public interface OnCounterReadListener {
        ...
        void onSignalReadRssi(String value); //agregar un metodo para pasar el valor de rssi
    ...
    private BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onReadRemoteRssi(BluetoothGatt gatt, int rssi, int status) {
            Log.i(TAG, "Señal"+String.valueOf(rssi));
            //señales de radio entre menor sea el valor negativo, es mejor señal
           // super.onReadRemoteRssi(gatt, rssi, status);
           mListener.onSignalReadRssi(String.valueOf(rssi));
        }

        @Override
        public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
            if (newState == BluetoothProfile.STATE_CONNECTED) {
             boolean rs= mBluetoothGatt.readRemoteRssi();
        ...
        public void onServicesDiscovered(BluetoothGatt gatt, int status) {
            if (status == BluetoothGatt.GATT_SUCCESS) {
                ...
                BluetoothGattService service = gatt.getService(SERVICE_UUID_FIRST);
                if (service != null) {
        ...
        public void onDescriptorWrite(BluetoothGatt gatt, BluetoothGattDescriptor descriptor, int status) {
            if (DESCRIPTOR_CONFIG.equals(descriptor.getUuid())) {
                BluetoothGattCharacteristic characteristic = gatt.getService(SERVICE_UUID_FIRST).getCharacteristic(CHARACTERISTIC_COUNTER_UUID);
