...
public class ScanActivity extends AppCompatActivity {
    ...
    private static final long SCAN_TIMEOUT_MS = 15_000;//10_000;
    ...
    private final ScanCallback mScanCallback = new ScanCallback() {
        ...
        public void onBatchScanResults(List<ScanResult> results) {
            ...
            if (!results.isEmpty()) {
                ...
                isMacAddressAutorized(result.getDevice());
            }
        }
    ...
    private void startLeScan() {
        ...
        filters.add(new ScanFilter.Builder().setServiceUuid(new ParcelUuid(SERVICE_UUID_FIRST)).build());
