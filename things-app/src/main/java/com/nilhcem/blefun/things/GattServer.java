...
public class GattServer {
    ...
    private void startAdvertising() {
        ...
        AdvertiseData data = new AdvertiseData.Builder()
                ...
                .addServiceUuid(new ParcelUuid(SERVICE_UUID_FIRST))
                .build();
    ...
    private BluetoothGattService createAwesomenessService() {
        BluetoothGattService service = new BluetoothGattService(SERVICE_UUID_FIRST, BluetoothGattService.SERVICE_TYPE_PRIMARY);
